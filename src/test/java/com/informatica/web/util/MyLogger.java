...
public class MyLogger {
	...
	public static synchronized void startLogger(String sTestCaseName) {
		...
		startLog(Constants.LOGGER_FOLDER+File.separator+PODFileManager.getProperty("Environment_Name"), sTestCaseName);
	...
	private static void startLog(String dirPath, String testCaseName) {
		...
		String logFolder = dirPath;
		ThreadContext.put("logFilename", logFileName);
		ThreadContext.put("logFolder", logFolder);
